    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-12 animate-in fade-in duration-700">
        <section className="glass rounded-2xl p-8 md:p-12 space-y-6 relative overflow-hidden">
          ...
          <h2 className="text-xl font-semibold text-primary uppercase tracking-widest">Web Backend Development Recruitment</h2>
          <p className="text-lg text-muted-foreground leading-relaxed max-w-3xl">
            Handle the backbone of the Plenum platform. We're looking for developers who can
            build robust APIs, manage databases, and ensure our services are secure and scalable.
          </p>
          <div className="flex items-center gap-2 text-sm text-muted-foreground">
            <CheckCircle2 className="w-4 h-4 text-primary" />
            <span>Ready to build the engine of B2B trade?</span>
          </div>
        </section>
